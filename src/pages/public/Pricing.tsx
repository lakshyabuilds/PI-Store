  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-24 md:py-32">
      <JsonLd data={{
        ...
        "@type": "WebPage",
        "name": "Pricing - Pi-Store",
        "description": "Start your digital product empire for just ₹99/month."
      }} />
      
      <div className="text-center mb-16 px-4">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-text-main tracking-tight mb-6">Insane Value.<br/> Ridiculous Price.</h1>
      ...
      <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
        ...
        <div className="space-y-8 order-2 lg:order-1">
           <h3 className="text-3xl font-black text-text-main">What You Get Today:</h3>
           <div className="space-y-6">
              ...
              <div className="flex gap-4 items-start">
                 ...
                 <div>
                    ...
                    <p className="text-text-muted font-medium mt-1">Instant access to our library of PLR ebooks, templates, and courses. Sell them as your own immediately.</p>
                 </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                 ...
                 <div>
                    ...
                    <p className="text-text-muted font-medium mt-1">A mobile-optimized store engineered purely to convert visitors into buyers effortlessly.</p>
                 </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                 ...
                 <div>
                    ...
                    <p className="text-text-muted font-medium mt-1">We handle the transactions. No complex Stripe or Razorpay setups required on your end.</p>
                 </div>
              </div>
        ...
        <div className="neo-card p-6 sm:p-10 bg-bg-card border-2 border-primary text-center relative flex flex-col order-1 lg:order-2 shadow-[0_0_50px_rgba(57,255,20,0.1)]">
           ...
           <h3 className="text-3xl font-black text-text-main mt-6 mb-2">Pi-Store Access</h3>
           <p className="text-text-muted font-medium mb-8">Everything you need to launch a digital empire today.</p>
           
           <div className="flex justify-center items-end gap-1 mb-8">
             <div className="text-7xl font-black text-text-main leading-none">₹99</div>
           ...
           <div className="bg-alert/10 border border-alert/20 rounded-xl p-4 mb-8 text-center">
              ...
              <p className="text-text-main font-semibold">Test drive everything for <span className="font-black text-alert">7 Days for just ₹1</span>.</p>
           </div>
           
           <Link to="/register" className="neo-button w-full py-4 sm:py-5 text-lg sm:text-xl font-black bg-primary text-bg-base shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all flex items-center justify-center gap-2 rounded-2xl">
